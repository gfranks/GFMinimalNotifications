    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.sample_show:
                mCurrentNotification = GFMinimalNotification.make(getView(), mText.getText().toString(), GFMinimalNotification.LENGTH_LONG, mType);
            ...
            case R.id.sample_show_no_duration:
                mCurrentNotification = GFMinimalNotification.make(getView(), mText.getText().toString(), GFMinimalNotification.LENGTH_INDEFINITE, mType);
                mCurrentNotification.setDirection(mDirection);
                mCurrentNotification.setHelperImage(mHelperResId);
                mCurrentNotification.setActionImage(mActionResId, new GFMinimalNotification.OnActionClickListener() {
                    @Override
